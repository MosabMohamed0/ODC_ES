...
#define SSD_A_PIN				    GPIO_PIN12

#define SSD_C_PORT					GPIO_PORTF
#define SSD_A_PIN				    GPIO_PIN6

#define SSD_D_PORT					GPIO_PORTF
#define SSD_A_PIN				    GPIO_PIN7

#define SSD_E_PORT					GPIO_PORTA
#define SSD_A_PIN				    GPIO_PIN13

#define SSD_F_PORT					GPIO_PORTA
#define SSD_A_PIN				    GPIO_PIN14

#define SSD_G_PORT					GPIO_PORTA
#define SSD_A_PIN				    GPIO_PIN15
